...
<div class="form-container">
    ...
    <form action="{{ route('admin.jurusan.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <input type="text" name="nama_jurusan" id="nama_jurusan" required placeholder="Masukkan nama jurusan">
        </div>

        <div class="form-group">
            <label for="deskripsi">Deskripsi:</label>
            <textarea name="deskripsi" id="content"  placeholder="Tulis deskripsi jurusan"></textarea>
        </div>

        <div class="form-group">
            <label for="logo_jurusan">Logo Jurusan:</label>
            <input type="file" name="logo_jurusan" id="logo_jurusan" accept="image/*" onchange="previewLogo(event)">
            <div class="image-preview" id="logoPreview">
                <img id="logoImage" src="" alt="Preview Logo" style="display: none;">
            </div>
        </div>

        <button type="submit" class="btn-submit">Simpan Jurusan</button>
    </form>
</div>
