...
<div class="container detail-container">
    ...
    <div class="left-content">
        @if ($ekskuls->logo)
            <img src="{{ asset('storage/' . $ekskuls->logo) }}" alt="Logo {{ $ekskuls->nama_ekskul }}" class="logo-img">
        @endif

        <h1 class="article-title">{{ strtoupper($ekskuls->nama) }}</h1>

        <div class="article-content">
            <p>{{(strip_tags($ekskuls->deskripsi)) }}</p>
        </div>
        ...
        <div style="margin-top: 30px;">
            <a href="{{ route('ekskul.index') }}" class="btn-back">← Lihat Daftar Ekstrakurikuler</a>
        </div>
    </div>
