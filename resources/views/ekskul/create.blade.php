...
@section('title', 'Tambah Ekskul Baru')
...
<div class="form-container">
    <h1>Tambah Ekskul Baru</h1>
    <form action="{{ route('admin.ekskul.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="form-group">
            <label for="nama">Nama Ekskul:</label>
            <input type="text" name="nama" id="nama" required placeholder="Masukkan nama ekskul">
        </div>

        <div class="form-group">
            <label for="deskripsi">Deskripsi:</label>
            <textarea name="deskripsi" id="content"  placeholder="Tulis deskripsi ekskul"></textarea>
        </div>
