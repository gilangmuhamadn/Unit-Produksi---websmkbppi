...
<div class="container">
        ...
        @foreach ($articles as $article)
            <div class="card">
                ...
                <div class="card-body">
                    <!-- Judul Artikel -->
                    <h5 class="card-title">
                        <a href="{{ route('articles.show', $article->id) }}" class="article-link">{{ $article->title }}</a>
                    </h5>
    ...
    @csrf
    @method('DELETE')
    <button type="button" class="btn btn-danger btn-sm delete-btn" data-id="{{ $article->id }}" data-title="{{ $article->title }}">Hapus</button>
</form>
