...
<div class="form-container">
    <form action="{{ route('admin.staff.update', $staff->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <textarea name="quote" id="quote" required>{{ $staff->quote }}</textarea>
        </div>

        <div class="form-group">
            <label for="type">Jenis Staf:</label>
            <select name="type" id="type" required>
                <option value="pengajar" {{ $staff->type == 'pengajar' ? 'selected' : '' }}>Staf Pengajar</option>
                <option value="tu" {{ $staff->type == 'tu' ? 'selected' : '' }}>Staf TU</option>
            </select>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="image-preview" id="imagePreview">
                <img id="preview" src="{{ asset('storage/' . $staff->photo) }}" alt="Preview Foto">
            </div>
        </div>
...
<script>
    function previewImage(event) {
        ...
        if (file) {
            ...
            preview.src = '{{ asset('storage/' . $staff->photo) }}';
        }
    }
</script>
@endsection
